...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; color: #111827; max-width: 600px; margin: 0 auto; padding: 24px;">
    <h1 style="color: {{ $primary }}; margin: 0 0 8px;">New order received</h1>
    <p style="color: #4b5563;">A new order has been placed at <strong>{{ $restaurant?->name }}</strong>.</p>
    ...
    @if ($order->notes)
        <p style="margin-top: 16px; color: #6b7280;"><em>Customer notes: {{ $order->notes }}</em></p>
    @endif
</body>
</html>
