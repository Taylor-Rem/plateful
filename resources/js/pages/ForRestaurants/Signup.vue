    ...
    >
        ...
        <main class="mx-auto max-w-3xl px-6 py-12">
            ...
            <p class="mt-2 text-sm text-[#1b1b18]/70 dark:text-[#EDEDEC]/70">
                Tell us a bit about your restaurant and pick a subdomain. Next
                you'll add your menu, set your hours, and connect payments —
                then go live.
            </p>
            ...
            >
                ...
                <section class="grid gap-6">
                    ...
                    <div class="grid gap-2">
                        ...
                        <p
                            class="text-xs text-[#1b1b18]/50 dark:text-[#EDEDEC]/50"
                        >
                    ...
                    <div class="grid gap-2">
                        ...
                        <p
                            class="text-xs text-[#1b1b18]/50 dark:text-[#EDEDEC]/50"
                        >
                            We'll prefill a sample menu you can rename,
                            re-price, or delete later.
                        </p>
