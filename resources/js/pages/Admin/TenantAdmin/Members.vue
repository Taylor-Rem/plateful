        ...
        <div class="space-y-8">
            ...
            <section class="rounded-lg border border-border bg-card p-6">
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Admins can manage menus, settings, and team members. Staff
                    can manage orders, hours, and item availability.
                </p>
                <form
                    class="mt-4 grid gap-3 sm:grid-cols-[1fr_180px_auto] sm:items-end"
                    ...
                    >
                        <div>
                            ...
                            <div class="text-xs text-muted-foreground">
                                ...
                                Invited by
                                {{ inv.invitedByName ?? 'Unknown' }} · Expires
                        ...
                        <Button
                            variant="outline"
                            size="sm"
                            @click="revokeInvitation(inv.id, inv.email)"
                        >
                            Revoke
                        </Button>
                    </li>
