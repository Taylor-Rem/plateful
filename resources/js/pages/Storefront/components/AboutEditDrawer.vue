...
const currentImage = computed(() => props.restaurant.aboutImageMediumUrl ?? props.restaurant.aboutImageUrl ?? null);
        ...
        <SheetContent class="w-full max-w-xl overflow-y-auto sm:max-w-xl">
            ...
            <form class="space-y-5 px-4 py-4" @submit.prevent="submit">
                <div class="grid gap-2">
                    ...
                    />
                    <p class="text-xs text-muted-foreground">Separate paragraphs with a blank line.</p>
                ...
                <div class="grid gap-2">
                    <Label>Photo</Label>
                    <div class="space-y-2">
                        <div class="aspect-[4/3] w-full overflow-hidden rounded-md border border-dashed border-border bg-muted/30">
