...
<template>
    <footer class="border-t border-border bg-card text-foreground">
        <div
            class="mx-auto grid max-w-5xl gap-8 px-6 py-10 sm:grid-cols-2 md:grid-cols-3"
        >
            <div>
                <h3
        ...
        <div class="border-t border-border">
            <div
                class="mx-auto flex max-w-5xl flex-col items-start justify-between gap-2 px-6 py-4 text-xs text-foreground/60 sm:flex-row sm:items-center"
            >
                <p>© {{ year }} {{ restaurant.name }}. All rights reserved.</p>
                <p>
                    Powered by
                    <a
                        href="https://plateful.fyi"
                        target="_blank"
                        rel="noopener"
