...
class Restaurant extends Model
{
    ...
    protected $fillable = [
        ...
        'tax_rate_percent',
        'delivery_fee_cents',
        'pickup_refunds_enabled',
        'delivery_refunds_enabled',
        'refund_policy_reviewed_at',
        'delivery_enabled',
        'delivery_mode',
    ...
    protected function casts(): array
    {
        return [
            ...
            'pickup_refunds_enabled' => 'boolean',
            'delivery_refunds_enabled' => 'boolean',
            'refund_policy_reviewed_at' => 'datetime',
